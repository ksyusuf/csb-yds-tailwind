  ...
  const handleFilterChange = (header: ColumnKey, value: string, type: Filter['type']) => {
    ...
    return (
      <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center z-50">
        <div className="relative bg-white p-6 rounded-lg shadow-lg w-11/12 md:w-1/2 max-h-[80vh] overflow-y-auto transition-transform transform-gpu">
          <div className="sticky top-0 bg-white p-4 border-b z-10 shadow-md">
          ...
          <div className="sticky bottom-0 bg-white p-4 border-t z-10 flex justify-end shadow-md">
            <button
              type="button"
            ...
            <button
              type="button"
              className="text-white bg-gradient-to-r from-red-400 to-pink-300 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2"
              onClick={closePopup}>
              İptal
            </button>
          </div>
